...
// let url = 'https://data.lass-net.org/data/last-all-epa.json'
let url = 'https://data.lass-net.org/data/last-all-lass.json'
// let url = 'https://data.lass-net.org/data/last-all-lass4u.json'
